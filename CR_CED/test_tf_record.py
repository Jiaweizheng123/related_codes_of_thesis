...
def tf_record_parser(record):
    ...
    reverb_stft_mag_features = tf.reshape(reverb_stft_mag_features, (n_features, 8, 1), name="reverb_stft_mag_features")
    clean_stft_magnitude = tf.reshape(clean_stft_magnitude, (n_features, 1, 1), name="clean_stft_magnitude")
    reverb_stft_phase = tf.reshape(reverb_stft_phase, (n_features,), name="reverb_stft_phase")

    return reverb_stft_mag_features, clean_stft_magnitude, reverb_stft_phase
