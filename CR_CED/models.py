##generate the architecture of CR-CED network
...
def full_pre_activation_block(x, filters, kernel_size, strides, padding='same', use_bn=True):
  ...
  return shortcut + x
## each layer contain convolutional layer, ReLU function and batch normalization
def build_model(l2_strength):
  ...
  ## use Adam as gradient descent and use fixed learning rate
